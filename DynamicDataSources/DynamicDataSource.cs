...
using CsabaDu.DynamicTestData.Lite.DataStrategyTypes.Interfaces;
...
{
    protected abstract TRow Convert<TTestData>(TTestData testData)
    where TTestData : notnull, ITestData;

    #region Convert methods
    #region Convert (Standard test cases)
    /// <summary>
    ...
    /// <inheritdoc cref="Convert{T1}"/>
    protected TRow Convert<T1, T2>(
        string definition,
        string expected,
        T1? arg1, T2? arg2)
    => Convert(
    ...
    /// <inheritdoc cref="Convert{T1, T2}" />
    /// <typeparam name="T3">The type of the third argument.</typeparam>
    /// <param name="arg3">The third argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow Convert<T1, T2, T3>(
        string definition,
        string expected,
    ...
    /// <inheritdoc cref="Convert{T1, T2, T3}" />
    /// <typeparam name="T4">The type of the fourth argument.</typeparam>
    /// <param name="arg4">The fourth argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow Convert<T1, T2, T3, T4>(
        string definition,
        string expected,
    ...
    /// <inheritdoc cref="Convert{T1, T2, T3, T4}" />
    /// <typeparam name="T5">The type of the fifth argument.</typeparam>
    /// <param name="arg5">The fifth argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow Convert<T1, T2, T3, T4, T5>(
        string definition,
        string expected,
    ...
    /// <inheritdoc cref="Convert{T1, T2, T3, T4, T5}" />
    /// <typeparam name="T6">The type of the sixth argument.</typeparam>
    /// <param name="arg6">The sixth argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow Convert<T1, T2, T3, T4, T5, T6>(
        string definition,
        string expected,
    ...
    /// <inheritdoc cref="Convert{T1, T2, T3, T4, T5, T6}" />
    /// <typeparam name="T7">The type of the seventh argument.</typeparam>
    /// <param name="arg7">The seventh argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow Convert<T1, T2, T3, T4, T5, T6, T7>(
        string definition,
        string expected,
    ...
    /// <inheritdoc cref="Convert{T1, T2, T3, T4, T5, T6, T7}" />
    /// <typeparam name="T8">The type of the eighth argument.</typeparam>
    /// <param name="arg8">The eighth argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow Convert<T1, T2, T3, T4, T5, T6, T7, T8>(
        string definition,
        string expected,
    ...
    /// <inheritdoc cref="Convert{T1, T2, T3, T4, T5, T6, T7, T8}" />
    /// <typeparam name="T9">The type of the ninth argument.</typeparam>
    /// <param name="arg9">The ninth argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow Convert<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
        string definition,
        string expected,
    ...
    /// </exception>
    protected TRow ConvertReturns<TStruct, T1>(
        string definition,
        TStruct expected,
        T1? arg1)
    ...
    /// <typeparam name="T1">Type of the first test argument.</typeparam>
    /// <typeparam name="T2">Type of the second test argument.</typeparam>
    /// <inheritdoc cref="ConvertReturns{TStruct, T1}"/>
    protected TRow ConvertReturns<TStruct, T1, T2>(
        string definition,
        TStruct expected,
        T1? arg1, T2? arg2)
    where TStruct : struct
    ...
    /// <inheritdoc cref="ConvertReturns{TStruct, T1, T2}" />
    /// <typeparam name="T3">The type of the third argument.</typeparam>
    /// <param name="arg3">The third argument.</param>
    protected TRow ConvertReturns<TStruct, T1, T2, T3>(
        string definition,
        TStruct expected,
        T1? arg1, T2? arg2, T3? arg3)
    where TStruct : struct
    ...
    /// <inheritdoc cref="ConvertReturns{TStruct, T1, T2, T3}" />
    /// <typeparam name="T4">The type of the fourth argument.</typeparam>
    /// <param name="arg4">The fourth argument.</param>
    /// <returns>An array of arguments.</returns>
    protected TRow ConvertReturns<TStruct, T1, T2, T3, T4>(
        string definition,
        TStruct expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4)
    where TStruct : struct
    ...
    /// <inheritdoc cref="ConvertReturns{TStruct, T1, T2, T3, T4}" />
    /// <typeparam name="T5">The type of the fifth argument.</typeparam>
    /// <param name="arg5">The fifth argument.</param>
    protected TRow ConvertReturns<TStruct, T1, T2, T3, T4, T5>(
        string definition,
        TStruct expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5)
    where TStruct : struct
    ...
    /// <inheritdoc cref="ConvertReturns{TStruct, T1, T2, T3, T4, T5}" />
    /// <typeparam name="T6">The type of the sixth argument.</typeparam>
    /// <param name="arg6">The sixth argument.</param>
    protected TRow ConvertReturns<TStruct, T1, T2, T3, T4, T5, T6>(
        string definition,
        TStruct expected,
    ...
    /// <inheritdoc cref="ConvertReturns{TStruct, T1, T2, T3, T4, T5, T6}" />
    /// <typeparam name="T7">The type of the seventh argument.</typeparam>
    /// <param name="arg7">The seventh argument.</param>
    protected TRow ConvertReturns<TStruct, T1, T2, T3, T4, T5, T6, T7>(
        string definition,
        TStruct expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7)
    where TStruct : struct
    ...
    /// <inheritdoc cref="ConvertReturns{TStruct, T1, T2, T3, T4, T5, T6, T7}" />
    /// <typeparam name="T8">The type of the eighth argument.</typeparam>
    /// <param name="arg8">The eighth argument.</param>
    protected TRow ConvertReturns<TStruct, T1, T2, T3, T4, T5, T6, T7, T8>(
        string definition,
        TStruct expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7, T8? arg8)
    where TStruct : struct
    ...
    /// <inheritdoc cref="ConvertReturns{TStruct, T1, T2, T3, T4, T5, T6, T7, t8}" />
    /// <typeparam name="T9">The type of the ninth argument.</typeparam>
    /// <param name="arg9">The ninth argument.</param>
    protected TRow ConvertReturns<TStruct, T1, T2, T3, T4, T5, T6, T7, T8, T9>(
        string definition,
        TStruct expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7, T8? arg8, T9? arg9)
    where TStruct : struct
    ...
    /// Thrown when current ArgsCode configuration is invalid.
    /// </exception>
    protected TRow ConvertThrows<TException, T1>(
        string definition,
        TException expected,
        T1? arg1)
    ...
    /// <typeparam name="T1">Type of the first test argument.</typeparam>
    /// <typeparam name="T2">Type of the second test argument.</typeparam>
    /// <inheritdoc cref="ConvertThrows{TException, T1}"/>
    protected TRow ConvertThrows<TException, T1, T2>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2)
        where TException : Exception
    ...
    /// <inheritdoc cref="ConvertThrows{TException, T1, T2}" />
    /// <typeparam name="T3">The type of the third argument.</typeparam>
    /// <param name="arg3">The third argument.</param>
    protected TRow ConvertThrows<TException, T1, T2, T3>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2, T3? arg3)
    where TException : Exception
    ...
    /// <inheritdoc cref="ConvertThrows{TException, T1, T2, T3}" />
    /// <typeparam name="T4">The type of the fourth argument.</typeparam>
    /// <param name="arg4">The fourth argument.</param>
    protected TRow ConvertThrows<TException, T1, T2, T3, T4>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4)
    where TException : Exception
    ...
    /// <inheritdoc cref="ConvertThrows{TException, T1, T2, T3, T4}" />
    /// <typeparam name="T5">The type of the fifth argument.</typeparam>
    /// <param name="arg5">The fifth argument.</param>
    protected TRow ConvertThrows<TException, T1, T2, T3, T4, T5>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5)
    where TException : Exception
    ...
    /// <inheritdoc cref="ConvertThrows{TException, T1, T2, T3, T4, T5}" />
    /// <typeparam name="T6">The type of the sixth argument.</typeparam>
    /// <param name="arg6">The sixth argument.</param>
    protected TRow ConvertThrows<TException, T1, T2, T3, T4, T5, T6>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6)
    where TException : Exception
    ...
    /// <inheritdoc cref="ConvertThrows{TException, T1, T2, T3, T4, T5, T6}" />
    /// <typeparam name="T7">The type of the seventh argument.</typeparam>
    /// <param name="arg7">The seventh argument.</param>
    protected TRow ConvertThrows<TException, T1, T2, T3, T4, T5, T6, T7>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7)
    where TException : Exception
    ...
    /// <inheritdoc cref="ConvertThrows{TException, T1, T2, T3, T4, T5, T6, T7}" />
    /// <typeparam name="T8">The type of the eighth argument.</typeparam>
    /// <param name="arg8">The eighth argument.</param>
    protected TRow ConvertThrows<TException, T1, T2, T3, T4, T5, T6, T7, T8>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7, T8? arg8)
    where TException : Exception
    ...
    /// <inheritdoc cref="ConvertThrows{TException, T1, T2, T3, T4, T5, T6, T7, T8}" />
    /// <typeparam name="T9">The type of the ninth argument.</typeparam>
    /// <param name="arg9">The ninth argument.</param>
    protected TRow ConvertThrows<TException, T1, T2, T3, T4, T5, T6, T7, T8, T9>(
        string definition,
        TException expected,
        T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7, T8? arg8, T9? arg9)
    where TException : Exception
